...
{
    /// <summary>
    /// Логика взаимодействия для EditUsersInfoUserControl.xaml
    /// </summary>
    public partial class EditUsersInfoUserControl : UserControl
    {
        //public EditUsersInfoUserControl()
        //{
        //    InitializeComponent();
        //    FillWithList();
        //}
        ...
        //private void LoadUserInfo(User userr)
        //{
        //    try
        //    {
        //        using BlueFoxContext db = new BlueFoxContext();
        //        var user = db.Users.FirstOrDefault(u => u.User_Id == userr.User_Id);
